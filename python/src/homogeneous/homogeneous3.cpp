...
namespace py_tbgal {
    ...
    auto py_vector(python::tuple args, python::dict kwargs) {
        ...
        auto a = tbgal::Homogeneous3::vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_euclidean_vector(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Homogeneous3::euclidean_vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_direction(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Homogeneous3::direction(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_point(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Homogeneous3::point(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto ep() {
        return tbgal::Homogeneous3::ep;
    }
    ...
    BOOST_PYTHON_MODULE(homogeneous3) {
        ...
        using OP = tbgal::OuterProduct<tbgal::HomogeneousMetricSpace<3>>;
        using GP = tbgal::GeometricProduct<tbgal::HomogeneousMetricSpace<3>>;
        ...
        python::def("e", &tbgal::Homogeneous3::e);
