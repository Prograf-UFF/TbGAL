...
namespace py_tbgal {
    ...
    auto py_vector(python::tuple args, python::dict kwargs) {
        ...
        auto a = tbgal::Homogeneous1::vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_euclidean_vector(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Homogeneous1::euclidean_vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_direction(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Homogeneous1::direction(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_point(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Homogeneous1::point(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto ep() {
        return tbgal::Homogeneous1::ep;
    }

    BOOST_PYTHON_MODULE(homogeneous1) {

        using namespace tbgal::Homogeneous1;

        using OP = tbgal::OuterProduct<tbgal::HomogeneousMetricSpace<1>>;
        using GP = tbgal::GeometricProduct<tbgal::HomogeneousMetricSpace<1>>;
        ...
        python::def("e", &tbgal::Homogeneous1::e);
