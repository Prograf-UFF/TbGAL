...
#include "../../../cpp/include/tbgal/assuming_Minkowski3.hpp"
...
namespace py_tbgal {
    ...
    auto py_vector(python::tuple args, python::dict kwargs) {
        ...
        auto a = tbgal::Minkowski3::vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_euclidean_vector(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Minkowski3::euclidean_vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_point(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Minkowski3::point(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto ep() {
        return tbgal::Minkowski3::ep;
    }

    auto em() {
        return tbgal::Minkowski3::em;
    }
    
    BOOST_PYTHON_MODULE(minkowski3) {

        using namespace tbgal::Minkowski3;

        using OP = tbgal::OuterProduct<tbgal::MinkowskiMetricSpace<3>>;
        using GP = tbgal::GeometricProduct<tbgal::MinkowskiMetricSpace<3>>;
        ...
        python::def("e", &tbgal::Minkowski3::e);
        python::def("ep", &ep);
        python::def("em", &em);
