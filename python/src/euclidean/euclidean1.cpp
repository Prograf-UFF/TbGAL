...
#include "../../../cpp/include/tbgal/assuming_Euclidean1.hpp"
...
namespace py_tbgal {
    ...
    auto py_vector(python::tuple args, python::dict kwargs) {
        ...
        auto a = tbgal::Euclidean1::vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    auto py_euclidean_vector(python::tuple args, python::dict kwargs) {
        std::vector<std::double_t> args_as_container = py_list_to_std_vector<std::double_t>(args);
        auto a = tbgal::Euclidean1::euclidean_vector(args_as_container.begin(), args_as_container.end());
        return a;
    }

    BOOST_PYTHON_MODULE(euclidean1) {

        using namespace tbgal::Euclidean1;

        using OP = tbgal::OuterProduct<tbgal::EuclideanMetricSpace<1>>;
        using GP = tbgal::GeometricProduct<tbgal::EuclideanMetricSpace<1>>;
        ...
        python::def("e", &tbgal::Euclidean1::e);
