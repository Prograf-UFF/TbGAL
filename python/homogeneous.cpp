...
BOOST_PYTHON_MODULE(homogeneous) {
    python::class_< tbgal::FactoredMultivector<double, tbgal::GeometricProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic>>> >("FactoredMultivector")
        // =========== just for printing =========== 
        .def("__repr__", &tbgal::FactoredMultivector<double, tbgal::GeometricProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic> > >::repr)
        // =========== OP =========== 
        // MV_GP ^ MV_OP
        .def(python::self ^ python::other<tbgal::FactoredMultivector<double, tbgal::OuterProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic> > >>())
        // MV_GP ^ MV_GP
        ...
        .def(python::self * python::other<tbgal::FactoredMultivector<double, tbgal::OuterProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic> > >>())
        // MV_GP * MV_GP
        .def(python::self * python::other<tbgal::FactoredMultivector<double, tbgal::GeometricProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic> > >>())
        // MV_GP * int
        .def(python::self * python::other<int>())
        // int * MV_GP
        .def(python::other<int>() * python::self)
    ...
    python::class_< tbgal::FactoredMultivector<double, tbgal::OuterProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic>>> >("FactoredMultivector")
        // =========== just for printing =========== 
        .def("__repr__", &tbgal::FactoredMultivector<double, tbgal::OuterProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic> > >::repr)
        // =========== OP =========== 
        // MV_OP ^ MV_GP
        .def(python::self ^ python::other<tbgal::FactoredMultivector<double, tbgal::GeometricProduct<tbgal::HomogeneousMetricSpace<Dynamic, Dynamic> > >>())
        // MV_OP ^ MV_OP
