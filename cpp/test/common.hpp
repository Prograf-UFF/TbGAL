...
constexpr decltype(auto) tbgal_Conjugation(Type const &arg) {
    return tbgal::conjugate(arg);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) tbgal_DotProduct(FirstType const &arg1, SecondType const &arg2) {
    return tbgal::dot(arg1, arg2);
}

template<typename Type>
constexpr decltype(auto) tbgal_Dualization(Type const &arg) {
    return tbgal::dual(arg);
}

template<typename FirstType, typename... NextTypes>
constexpr decltype(auto) tbgal_GeometricProduct(FirstType const &arg1, NextTypes const &... args) {
    return tbgal::gp(arg1, args...);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) tbgal_HestenesInnerProduct(FirstType const &arg1, SecondType const &arg2) {
    return tbgal::hip(arg1, arg2);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) tbgal_InverseGeometricProduct(FirstType const &arg1, SecondType const &arg2) {
...
template<typename Type>
constexpr decltype(auto) tbgal_Inversion(Type const &arg) {
...
template<typename Type>
constexpr decltype(auto) tbgal_Involution(Type const &arg) {
    return tbgal::involute(arg);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) tbgal_LeftContraction(FirstType const &arg1, SecondType const &arg2) {
    return tbgal::lcont(arg1, arg2);
}

template<typename Type>
constexpr decltype(auto) tbgal_Normalization(Type const &arg) {
...
template<typename FirstType, typename... NextTypes>
constexpr decltype(auto) tbgal_OuterProduct(FirstType const &arg1, NextTypes const &... args) {
    return tbgal::op(arg1, args...);
}

template<typename Type>
constexpr decltype(auto) tbgal_Reversion(Type const &arg) {
    return tbgal::reverse(arg);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) tbgal_RightContraction(FirstType const &arg1, SecondType const &arg2) {
    return tbgal::rcont(arg1, arg2);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) tbgal_ScalarProduct(FirstType const &arg1, SecondType const &arg2) {
    return tbgal::sp(arg1, arg2);
}

template<typename Type>
constexpr decltype(auto) tbgal_SquaredReverseNorm(Type const &arg) {
    return tbgal::rnorm_sqr(arg);
}

template<typename Type>
constexpr decltype(auto) tbgal_UnaryMinus(Type const &arg) {
    return -arg;
}

template<typename Type>
constexpr decltype(auto) tbgal_UnaryPlus(Type const &arg) {
    return +arg;
}

template<typename Type>
constexpr decltype(auto) tbgal_Undualization(Type const &arg) {
    return tbgal::undual(arg);
}

template<typename Type>
constexpr decltype(auto) gatl_Conjugation(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return conjugate(arg);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) gatl_DotProduct(FirstType const &arg1, SecondType const &arg2) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return dot(arg1, arg2);
}

template<typename Type>
constexpr decltype(auto) gatl_Dualization(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return dual(arg);
}

template<typename Type>
constexpr decltype(auto) gatl_GeometricProduct(Type const &arg) {
    return arg;
}

template<typename FirstType, typename... NextTypes>
constexpr decltype(auto) gatl_GeometricProduct(FirstType const &arg1, NextTypes const &... args) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return gp(arg1, gatl_GeometricProduct(args...));
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) gatl_HestenesInnerProduct(FirstType const &arg1, SecondType const &arg2) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return hip(arg1, arg2);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) gatl_InverseGeometricProduct(FirstType const &arg1, SecondType const &arg2) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
...
template<typename Type>
constexpr decltype(auto) gatl_Inversion(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
...
template<typename Type>
constexpr decltype(auto) gatl_Involution(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return involute(arg);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) gatl_LeftContraction(FirstType const &arg1, SecondType const &arg2) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return lcont(arg1, arg2);
}

template<typename Type>
constexpr decltype(auto) gatl_Normalization(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
...
template<typename Type>
constexpr decltype(auto) gatl_OuterProduct(Type const &arg) {
    return arg;
}

template<typename FirstType, typename... NextTypes>
constexpr decltype(auto) gatl_OuterProduct(FirstType const &arg1, NextTypes const &... args) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return op(arg1, gatl_OuterProduct(args...));
}

template<typename Type>
constexpr decltype(auto) gatl_Reversion(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return reverse(arg);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) gatl_RightContraction(FirstType const &arg1, SecondType const &arg2) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return rcont(arg1, arg2);
}

template<typename FirstType, typename SecondType>
constexpr decltype(auto) gatl_ScalarProduct(FirstType const &arg1, SecondType const &arg2) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return sp(arg1, arg2);
}

template<typename Type>
constexpr decltype(auto) gatl_SquaredReverseNorm(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return rnorm_sqr(arg);
}

template<typename Type>
constexpr decltype(auto) gatl_UnaryMinus(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return -arg;
}

template<typename Type>
constexpr decltype(auto) gatl_UnaryPlus(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return +arg;
}

template<typename Type>
constexpr decltype(auto) gatl_Undualization(Type const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return undual(arg);
}

decltype(auto) make_tbgal_vector(vector_factor_t const &arg) {
    using namespace TESTING_TBGAL_MODEL_NAMESPACE;
    return vector(arg.begin(), arg.end());
}

constexpr decltype(auto) make_gatl_vector(vector_factor_t const &arg) {
    using namespace TESTING_GATL_MODEL_NAMESPACE;
    return vector(arg.begin(), arg.end());
}

template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, std::size_t... Indices>
constexpr decltype(auto) _make_tbgal_multivector_using_GeometricProduct_impl(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors, std::index_sequence<Indices...>) {
    using namespace TESTING_TBGAL_MODEL_NAMESPACE;
...
constexpr decltype(auto) make_tbgal_multivector_using_GeometricProduct(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors) {
    return _make_tbgal_multivector_using_GeometricProduct_impl(scalar_factor, vector_factors, Indices{});
}

template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, std::size_t... Indices>
constexpr decltype(auto) _make_gatl_multivector_using_GeometricProduct_impl(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors, std::index_sequence<Indices...>) {
    return gatl_GeometricProduct(scalar_factor, make_gatl_vector(vector_factors[Indices])...);
}
 
template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, typename Indices = std::make_index_sequence<K> >
constexpr decltype(auto) make_gatl_multivector_using_GeometricProduct(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors) {
    return _make_gatl_multivector_using_GeometricProduct_impl(scalar_factor, vector_factors, Indices{});
}

template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, std::size_t... Indices>
constexpr decltype(auto) _make_tbgal_multivector_using_OuterProduct_impl(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors, std::index_sequence<Indices...>) {
    using namespace TESTING_TBGAL_MODEL_NAMESPACE;
    return tbgal_OuterProduct(scalar(scalar_factor), make_tbgal_vector(vector_factors[Indices])...);
}
 
template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, typename Indices = std::make_index_sequence<K> >
constexpr decltype(auto) make_tbgal_multivector_using_OuterProduct(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors) {
    return _make_tbgal_multivector_using_OuterProduct_impl(scalar_factor, vector_factors, Indices{});
}

template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, std::size_t... Indices>
constexpr decltype(auto) _make_gatl_multivector_using_OuterProduct_impl(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors, std::index_sequence<Indices...>) {
    return gatl_OuterProduct(scalar_factor, make_gatl_vector(vector_factors[Indices])...);
}
 
template<typename ScalarFactorType, typename VectorFactorType, std::size_t K, typename Indices = std::make_index_sequence<K> >
constexpr decltype(auto) make_gatl_multivector_using_OuterProduct(ScalarFactorType const &scalar_factor, std::array<VectorFactorType, K> const &vector_factors) {
...
decltype(auto) from_tbgal_to_gatl(tbgal::FactoredMultivector<ScalarType, tbgal::GeometricProduct<MetricSpaceType> > const &arg) {
...
template<typename ScalarType, typename MetricSpaceType>
decltype(auto) from_tbgal_to_gatl(tbgal::FactoredMultivector<ScalarType, tbgal::OuterProduct<MetricSpaceType> > const &arg) {
...
template<typename ScalarType, typename = std::enable_if_t<!tbgal::is_multivector_v<ScalarType>, int> >
decltype(auto) from_tbgal_to_gatl(ScalarType const &arg) {
    return arg;
}

template<std::size_t K>
std::tuple<scalar_factor_t, std::array<vector_factor_t, K> > make_random_factors() {
...
constexpr bool same_multivector(ga::clifford_expression<LeftCoefficientType, LeftExpression> const &arg1, ga::clifford_expression<RightCoefficientType, RightExpression> const &arg2) {
    return ga::is_zero(arg1 - arg2);
}

template<typename LeftType, typename RightCoefficientType, typename RightExpression, typename = std::enable_if_t<!ga::is_clifford_expression_v<LeftType>, int> >
constexpr bool same_multivector(LeftType const &arg1, ga::clifford_expression<RightCoefficientType, RightExpression> const &arg2) {
    return same_multivector(ga::scalar(arg1), arg2);
}

template<typename LeftCoefficientType, typename LeftExpression, typename RightType, typename = std::enable_if_t<!ga::is_clifford_expression_v<RightType>, int> >
constexpr bool same_multivector(ga::clifford_expression<LeftCoefficientType, LeftExpression> const &arg1, RightType const &arg2) {
    return same_multivector(arg1, ga::scalar(arg2));
}

template<typename LeftType, typename RightType, typename = std::enable_if_t<!(ga::is_clifford_expression_v<LeftType> || ga::is_clifford_expression_v<RightType>), int> >
constexpr bool same_multivector(LeftType const &arg1, RightType const &arg2) {
