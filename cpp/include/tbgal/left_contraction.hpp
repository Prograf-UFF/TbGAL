...
namespace tbgal {
    ...
    constexpr decltype(auto) lcont(FactoredMultivector<FirstScalarType, FirstFactoringProductType> const &arg1, FactoredMultivector<SecondScalarType, SecondFactoringProductType> const &arg2) {
    ...
    constexpr decltype(auto) lcont(FactoredMultivector<FirstScalarType, FirstFactoringProductType> const &arg1, SecondScalarType const &arg2) {
    ...
    template<typename FirstScalarType, typename SecondScalarType, typename SecondMetricSpaceType, typename = std::enable_if_t<!is_multivector_v<FirstScalarType>, int> >
    constexpr decltype(auto) lcont(FirstScalarType const &arg1, FactoredMultivector<SecondScalarType, GeometricProduct<SecondMetricSpaceType> > const &arg2) {
    ...
    template<typename FirstScalarType, typename SecondScalarType, typename SecondMetricSpaceType, typename = std::enable_if_t<!is_multivector_v<FirstScalarType>, int> >
    constexpr decltype(auto) lcont(FirstScalarType const &arg1, FactoredMultivector<SecondScalarType, OuterProduct<SecondMetricSpaceType> > const &arg2) {
        using ResultingScalarType = std::common_type_t<FirstScalarType, SecondScalarType>;
    ...
    constexpr decltype(auto) lcont(FirstScalarType const &arg1, SecondScalarType const &arg2) {
        return arg1 * arg2;
    }
