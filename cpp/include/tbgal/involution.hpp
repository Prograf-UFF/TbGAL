...
namespace tbgal {
    ...
    constexpr decltype(auto) involution(FactoredMultivector<ScalarType, GeometricProduct<MetricSpaceType> > const &arg) noexcept {
        ...
        return ResultingFactoredMultivectorType(arg.space(), (arg.factors_count() & 1) ? -arg.scalar() : arg.scalar(), arg.factors_in_signed_metric());
    }
    ...
    constexpr decltype(auto) involution(FactoredMultivector<ScalarType, OuterProduct<MetricSpaceType> > const &arg) noexcept {
        ...
        using ResultingFactoredMultivectorType = FactoredMultivector<ResultingScalarType, ResultingFactoringProductType>;
        return ResultingFactoredMultivectorType(arg.space(), (arg.factors_count() & 1) ? -arg.scalar() : arg.scalar(), arg.factors_and_complement_in_signed_metric(), arg.factors_count());
    }
