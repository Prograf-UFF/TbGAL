...
namespace tbgal {
    ...
    private:
        ...
        template<typename SomeScalarType, typename SomeMetricSpaceType> friend constexpr decltype(auto) involute(FactoredMultivector<SomeScalarType, OuterProduct<SomeMetricSpaceType> > const &) noexcept;
