...
namespace tbgal {
    ...
    constexpr decltype(auto) subtraction(FactoredMultivector<FirstScalarType, FirstFactoringProductType> const &arg1, FactoredMultivector<SecondScalarType, SecondFactoringProductType> const &arg2) {
    ...
    constexpr decltype(auto) subtraction(FactoredMultivector<FirstScalarType, FirstFactoringProductType> const &arg1, SecondScalarType const &arg2) {
        if (arg1.factors_count() == 0) {
    ...
    constexpr decltype(auto) subtraction(FirstScalarType const &arg1, FactoredMultivector<SecondScalarType, SecondFactoringProductType> const &arg2) {
    ...
    constexpr decltype(auto) subtraction(FirstScalarType const &arg1, SecondScalarType const &arg2) {
        return arg1 - arg2;
    }

    template<typename FirstType, typename SecondType>
    constexpr decltype(auto) sub(FirstType const &arg1, SecondType const &arg2) {
